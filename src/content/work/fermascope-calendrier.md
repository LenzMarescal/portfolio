...
description: |
  ...
  Suite à ma précedente publication, centrée plutôt sur la première de couverture, ici je présente le calendrier.
tags:
  - Brochure
  - Retouches de photos avec Photoshop
  - Illustrator
filtre: 
  design
---
...
Tri de données grçace à un tableur pour suivre les ajouts, suppressions et modifications de dates par le client.
Ci-dessus, les deux premières pages de celui-ci, prévu en 5 pages.
